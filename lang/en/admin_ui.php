...
return [
    ...
    'menu' => [
        ...
        'json_hint' => 'The full menu is imported/exported as JSON with translatable labels and panel structure.',
        'new_item' => 'New item',
        ...
        'clear_all_confirm' => 'This action will remove all menus from App, Admin and Home before importing or rebuilding. Do you want to continue?',
        'actions' => [
            'move_up' => 'Move up',
            'move_down' => 'Move down',
            'drag' => 'Drag',
            ...
            'export' => 'Export',
            'import' => 'Import',
            'export_json' => 'Export full JSON',
            'import_json' => 'Import JSON',
            'export_panel_json' => 'Export panel',
            'export_excel' => 'Export Excel',
            'import_excel' => 'Import Excel',
            'clear_all' => 'Delete all',
            'clear_panel' => 'Clear panel',
            'clear_all_menus' => 'Delete menus',
        ],
        'notify' => [
