...
>
    <div class="flex flex-wrap items-center justify-end gap-2">
        ...
        />
        <x-starcho-btn-excel action="import" module="users" section="admin" />
    </div>
    ...
    >
        <span class="inline-flex items-center h-8 px-3 rounded-lg bg-white/80 dark:bg-zinc-900/70 text-xs font-semibold text-violet-700 dark:text-violet-300">
            ...
            <span class="ml-1">{{ __('admin_ui.users.bulk.selected') }}</span>
        </span>
        ...
        <button
            ...
            @click="window.Starcho.confirm({
                ...
                message: @js(__('admin_ui.users.bulk.delete_confirm')),
        ...
        >
            ...
            {{ __('admin_ui.users.bulk.delete_selected') }}
        </button>
        ...
        >
            ...
            {{ __('admin_ui.users.bulk.clear_selection') }}
        </button>
    </div>
</div>
