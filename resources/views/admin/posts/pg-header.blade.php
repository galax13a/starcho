...
>
    <div class="flex flex-wrap items-center justify-end gap-2">
        <button type="button" onclick="Livewire.dispatch('openPostAiCreator')"
                class="inline-flex items-center gap-1.5 h-8 px-3 rounded-lg border border-violet-200 bg-white text-violet-700 text-xs font-semibold transition hover:bg-violet-50 dark:border-violet-900/50 dark:bg-zinc-900 dark:text-violet-200">
    ...
    >
        ...
        <button type="button"
            @click="window.Starcho.confirm({
                ...
                message: '¿Eliminar los posts seleccionados?',
                okText: 'Eliminar',
                cancelText: 'Cancelar',
