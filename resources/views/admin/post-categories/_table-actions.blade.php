<div class="flex items-center gap-1">
    <button type="button"
        onclick="Livewire.dispatch('openPostCategory', {id: {{ $category->id }}})"
    ...
    <button type="button"
        @click="window.Starcho.confirm({
            ...
            message: '¿Eliminar «{{ addslashes($category->name) }}»?',
            okText: 'Eliminar',
            cancelText: 'Cancelar',
            onConfirm: () => $wire.dispatch('deletePostCategory', { id: {{ $category->id }} }),
        })"
