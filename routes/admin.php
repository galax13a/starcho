...
Route::prefix('admin')
    ...
    ->group(function () {
        ...
        Route::get('roles/export', [AdminDataTransferController::class, 'exportRoles'])->name('roles.export');
        ...
        Route::get('permissions/export', [AdminDataTransferController::class, 'exportPermissions'])->name('permissions.export');
        ...
        Route::get('users/export', [AdminDataTransferController::class, 'exportUsers'])->name('users.export');
        ...
        Route::get('tasks/export', [AdminDataTransferController::class, 'exportTasks'])->name('tasks.export');

        // ── Contacts (Index + Export + Import) ────────────────────────────────────
        Route::view('contacts', 'admin.contacts.index')->name('contacts.index');
        Route::get('contacts/export', [AdminDataTransferController::class, 'exportContacts'])->name('contacts.export');

        // ── Notes (Index + Export + Import) ───────────────────────────────────────
        Route::view('notes', 'admin.notes.index')->name('notes.index');
        Route::get('notes/export', [AdminDataTransferController::class, 'exportNotes'])->name('notes.export');
        ...
        Route::post('ai/featured-image', [AiImageController::class, 'featured'])->name('ai.featured-image');
