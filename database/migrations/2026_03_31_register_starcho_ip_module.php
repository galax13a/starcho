...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        \DB::table('starcho_modules')->updateOrInsert(
            ['key' => 'starcho-ip'],
            [
                'name' => json_encode(['es' => 'Geolocalización IP', 'en' => 'IP Geolocation']),
                'description' => json_encode(['es' => 'Capturar y rastrear geolocalización de usuarios al registrarse', 'en' => 'Capture and track user IP geolocation on registration']),
                'icon' => 'fas fa-globe',
                'installed' => true,
                'active' => false,
                'config' => json_encode([
