...
return new class extends Migration
{
    public function up(): void
    {
        ...
        // 2. Drop unique index if it still exists (raw check — Doctrine DBAL removed in L13)
        $indexExists = collect(DB::select("SHOW INDEX FROM posts WHERE Key_name = 'posts_slug_unique'"))->isNotEmpty();
        if ($indexExists) {
