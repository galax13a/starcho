 ...
 * site_languages, site_page_settings, content_settings, redes sociales,
 * storage, AI, starcho_modules, starcho_menu_sections y starcho_menu_items)
 * directamente como arrays PHP.
 *
 ...
 *
 * El seeder es aditivo por defecto: conserva configuracion, roles, permisos,
 * menus y usuarios existentes. Para refrescar defaults de forma explicita usa
 * STARCHO_INSTALL_REFRESH_DEFAULTS=true o --refresh-defaults desde el instalador.
 */
class StarchoInstallAppSeeder extends Seeder
{
    public function run(): void
    {
        app(StarchoInstallDataSeeder::class)->run($this->stateSnapshot());
        ...
        return [
            ...
            'content_settings' => [
                [
                    ...
                    'show_categories' => 1,
                    'show_tags' => 1,
                    'show_excerpt_in_list' => 1,
                    'show_featured_image_in_list' => 1,
                    'comments_enabled' => 1,
                    'comments_require_approval' => 0,
                    'blog_sidebar_enabled' => 1,
                    'breadcrumbs_enabled' => 1,
                    'track_broken_links' => 1,
                    ...
                    'render_cache_posts_enabled' => 1,
                    'render_cache_pages_enabled' => 1,
                    'render_cache_guest_only' => 1,
                    'render_cache_per_locale' => 1,
            ...
            'storage_settings' => [
                [
                    ...
                    'image_variant_sizes' => '[240,480,768,1200]',
                    'image_preview_variant_size' => 240,
                    'avatar_size' => 190,
                    'created_at' => '2026-06-10 00:00:00',
                    'updated_at' => '2026-06-10 00:00:00',
                ],
            ...
            'storage_plans' => [
                [
                    'id' => 1,
                    'name' => '{"es":"Gratis","en":"Free","pt_BR":"Gratis"}',
                    'description' => '{"es":"Plan inicial para probar Starcho.","en":"Starter plan to try Starcho.","pt_BR":"Plano inicial para testar Starcho."}',
                    'slug' => 'free',
                ...
                [
                    'id' => 2,
                    'name' => '{"es":"Basico","en":"Basic","pt_BR":"Basico"}',
                    'description' => '{"es":"Mas espacio para archivos y media liviana.","en":"More space for files and light media.","pt_BR":"Mais espaco para arquivos e midia leve."}',
                    'slug' => 'basic',
                ...
                [
                    'id' => 3,
                    'name' => '{"es":"Starter","en":"Starter","pt_BR":"Starter"}',
                    'description' => '{"es":"Para blogs y sitios en crecimiento.","en":"For growing blogs and sites.","pt_BR":"Para blogs e sites em crescimento."}',
                    'slug' => 'starter',
                ...
                [
                    'id' => 4,
                    'name' => '{"es":"Pro","en":"Pro","pt_BR":"Pro"}',
                    'description' => '{"es":"Media frecuente, galerias y contenido editorial.","en":"Frequent media, galleries and editorial content.","pt_BR":"Midia frequente, galerias e conteudo editorial."}',
                    'slug' => 'pro',
                ...
                [
                    'id' => 5,
                    'name' => '{"es":"Business","en":"Business","pt_BR":"Business"}',
                    'description' => '{"es":"Alto volumen para equipos y marcas.","en":"High volume for teams and brands.","pt_BR":"Alto volume para equipes e marcas."}',
                    'slug' => 'business',
                ...
                [
                    'id' => 6,
                    'name' => '{"es":"Agency","en":"Agency","pt_BR":"Agency"}',
                    'description' => '{"es":"Produccion intensiva para agencias.","en":"Intensive production for agencies.","pt_BR":"Producao intensiva para agencias."}',
                    'slug' => 'agency',
            ...
            'ai_settings' => [
                [
                    ...
                    'video_provider' => 'fal',
                    'video_model' => 'fal-ai/kling-video/v1.6/standard/text-to-video',
                    'model_settings' => '{"openai":[{"id":"gpt-5.4-nano","active":true},{"id":"gpt-5.4-mini","active":true},{"id":"gpt-5.4","active":true},{"id":"gpt-5.4-pro","active":false}],"deepseek":[{"id":"deepseek-chat","active":true},{"id":"deepseek-reasoner","active":true}],"anthropic":[{"id":"claude-sonnet-4-6","active":true},{"id":"claude-haiku-4-5-20251001","active":true}],"openrouter":[{"id":"openai/gpt-4o-mini","active":true},{"id":"anthropic/claude-sonnet-4.6","active":true},{"id":"google/gemini-2.0-flash-001","active":true},{"id":"deepseek/deepseek-chat","active":true}]}',
                    'image_model_settings' => '{"openai":[{"id":"gpt-image-1","active":true},{"id":"dall-e-3","active":true}],"fal":[{"id":"fal-ai/flux/schnell","active":true},{"id":"fal-ai/flux/dev","active":true},{"id":"fal-ai/flux-pro/v1.1","active":true},{"id":"fal-ai/recraft-v3","active":true}],"replicate":[{"id":"black-forest-labs/flux-schnell","active":true},{"id":"black-forest-labs/flux-dev","active":true},{"id":"black-forest-labs/flux-1.1-pro","active":true},{"id":"stability-ai/sdxl","active":true}]}',
                    'video_model_settings' => '{"fal":[{"id":"fal-ai/kling-video/v1.6/standard/text-to-video","active":true},{"id":"fal-ai/veo2","active":true},{"id":"fal-ai/minimax/video-01","active":true},{"id":"fal-ai/luma-dream-machine","active":true}],"replicate":[{"id":"kwaivgi/kling-v1.6-standard","active":true},{"id":"minimax/video-01","active":true},{"id":"wan-video/wan-2.2-t2v-fast","active":true},{"id":"tencent/hunyuan-video","active":true}]}',
                    'enabled' => 0,
                    'created_at' => '2026-06-10 00:00:00',
                    'updated_at' => '2026-06-10 00:00:00',
                ],
            ...
            'ai_plans' => [
                [
                    'id' => 1,
                    'name' => '{"es":"IA Gratis","en":"AI Free","pt_BR":"IA Gratis"}',
                    'description' => '{"es":"Para probar la generacion con IA.","en":"To try AI generation.","pt_BR":"Para testar geracao com IA."}',
                    'slug' => 'ai-free',
                    'monthly_price' => '0.00',
                    'is_free' => 1,
                    'is_active' => 1,
                    'sort_order' => 0,
                    'text_token_quota' => 30000,
                    'image_quota' => 3,
                    'video_quota' => 0,
                    'monthly_budget_cents' => 30,
                    'created_at' => '2026-06-10 00:00:00',
                    'updated_at' => '2026-06-10 00:00:00',
                ],
                [
                    'id' => 2,
                    'name' => '{"es":"IA Starter","en":"AI Starter","pt_BR":"IA Starter"}',
                    'description' => '{"es":"Uso ligero para creadores individuales.","en":"Light use for solo creators.","pt_BR":"Uso leve para criadores individuais."}',
                    'slug' => 'ai-starter',
                    'monthly_price' => '5.00',
                    'is_free' => 0,
                    'is_active' => 1,
                    'sort_order' => 1,
                    'text_token_quota' => 150000,
                    'image_quota' => 20,
                    'video_quota' => 2,
                ...
                [
                    'id' => 3,
                    'name' => '{"es":"IA Basico","en":"AI Basic","pt_BR":"IA Basico"}',
                    'description' => '{"es":"Para blogs y contenido regular.","en":"For blogs and regular content.","pt_BR":"Para blogs e conteudo regular."}',
                    'slug' => 'ai-basic',
                    'monthly_price' => '12.00',
                    'is_free' => 0,
                    'is_active' => 1,
                    'sort_order' => 2,
                    'text_token_quota' => 400000,
                    'image_quota' => 60,
                    'video_quota' => 6,
                    'monthly_budget_cents' => 800,
                    'created_at' => '2026-06-10 00:00:00',
                    'updated_at' => '2026-06-10 00:00:00',
                ],
                [
                    'id' => 4,
                    'name' => '{"es":"IA Pro","en":"AI Pro","pt_BR":"IA Pro"}',
                    'description' => '{"es":"Equipos pequenos y agencias.","en":"Small teams and agencies.","pt_BR":"Pequenas equipes e agencias."}',
                    'slug' => 'ai-pro',
                    'monthly_price' => '29.00',
                    'is_free' => 0,
                    'is_active' => 1,
                    'sort_order' => 3,
                    'text_token_quota' => 1000000,
                    'image_quota' => 150,
                    'video_quota' => 15,
                ...
                [
                    'id' => 5,
                    'name' => '{"es":"IA Business","en":"AI Business","pt_BR":"IA Business"}',
                    'description' => '{"es":"Alto volumen de contenido.","en":"High content volume.","pt_BR":"Alto volume de conteudo."}',
                    'slug' => 'ai-business',
                    'monthly_price' => '79.00',
                    'is_free' => 0,
                    'is_active' => 1,
                    'sort_order' => 4,
                    'text_token_quota' => 3000000,
                    'image_quota' => 400,
                    'video_quota' => 40,
                    'monthly_budget_cents' => 5500,
                    'created_at' => '2026-06-10 00:00:00',
                    'updated_at' => '2026-06-10 00:00:00',
                ],
                [
                    'id' => 6,
                    'name' => '{"es":"IA Studio","en":"AI Studio","pt_BR":"IA Studio"}',
                    'description' => '{"es":"Produccion intensiva de medios.","en":"Intensive media production.","pt_BR":"Producao intensiva de midia."}',
                    'slug' => 'ai-studio',
                    'monthly_price' => '199.00',
                    'is_free' => 0,
                    'is_active' => 1,
                    'sort_order' => 5,
                    'text_token_quota' => 8000000,
                    'image_quota' => 1000,
                    'video_quota' => 100,
                    'monthly_budget_cents' => 14000,
                    'created_at' => '2026-06-10 00:00:00',
                    'updated_at' => '2026-06-10 00:00:00',
                ],
                [
                    'id' => 7,
                    'name' => '{"es":"IA Enterprise","en":"AI Enterprise","pt_BR":"IA Enterprise"}',
                    'description' => '{"es":"Sin limites, soporte prioritario.","en":"Unlimited, priority support.","pt_BR":"Sem limites, suporte prioritario."}',
                    'slug' => 'ai-enterprise',
                    'monthly_price' => '499.00',
                    'is_free' => 0,
                    'is_active' => 1,
                    'sort_order' => 6,
                    'text_token_quota' => null,
                    'image_quota' => null,
                    'video_quota' => null,
    ...
    protected function seedGenericRows(string $table, array $rows, string $lookupColumn = 'id'): void
    {
        ...
        foreach ($rows as $row) {
            ...
            if (array_key_exists($lookupColumn, $payload)) {
                $lookup[$lookupColumn] = $payload[$lookupColumn];
